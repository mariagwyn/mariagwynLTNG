...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_lightningD8_PROD_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_lightningD8_PROD_dd.inc';
}
// </DDSETTINGS>
$databases['default']['default'] = array (
  'database' => 'lightningD8_PROD',
  'username' => 'drupaluser',
  'password' => '',
  'prefix' => '',
  'host' => '127.0.0.1',
...
$config_directories['sync'] = 'sites/lightningD8-PROD/custom-sync';
