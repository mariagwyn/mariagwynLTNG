 ...
 * @endcode
 */
$settings['hash_salt'] = 'tv7lD1_HA35psuA4TzTNGlv83DrOFveg7Jl-O4tbvJPQrExktKb4wlaOuQVQFOW-YRKoJ6t49Q';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_local_lightningd8_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_local_lightningd8_dd.inc';
}
// </DDSETTINGS>
$databases['default']['default'] = array (
  'database' => 'local_lightning_d8',
  'username' => 'drupaluser',
  'password' => '',
  'prefix' => '',
  'host' => '127.0.0.1',
...
$config_directories['sync'] = 'sites/local.lightningd8.dd/custom-sync';
